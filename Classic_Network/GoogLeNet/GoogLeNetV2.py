...
class InceptionV2(nn.Module):
    def __init__(self, in_channel, conv1x1, conv3x3R, conv3x3, conv5x5R, conv5x5, pool_proj):
        ...
        self.branch5x5 = nn.Sequential(
            ...
            convBNrelu(conv5x5R, conv5x5, 3, padding=1),  # 28 x 28 x conv5x5R => 28x 28 x conv5x5
            convBNrelu(conv5x5, conv5x5, 3, padding=1)  # 28 x 28 x conv5x5 => 28 x 28 x conv5xt
        )
...
class GoogleNet(nn.Module):
    def __init__(self):
        ...
        self.layer3 = nn.Sequential(
            InceptionV2(192, 64, 96, 128, 16, 32, 32),  # 28 x 28 x 192 => 28 x 28 x 256
            InceptionV2(256, 128, 128, 192, 32, 96, 64),  # 28 x 28 x 256 => 28 x 28 x 480
            nn.MaxPool2d(3, stride=2, ceil_mode=True)  # 28 x 28 x 480 => 14 x 14 x 480
        )

        self.layer4 = nn.Sequential(
            InceptionV2(480, 192, 96, 208, 16, 48, 64),  # 14 x 14 x 480 => 14 x 14 x 512
            InceptionV2(512, 160, 112, 224, 24, 64, 64),  # 14 x 14 x 512 => 14 x 14 x 512
            InceptionV2(512, 128, 128, 256, 24, 64, 64),  # 14 x 14 x 512 => 14 x 14 x 512
            InceptionV2(512, 112, 144, 288, 32, 64, 64),  # 14 x 14 x 512 => 14 x 14 x 528
            InceptionV2(528, 256, 160, 320, 32, 128, 128),  # 14 x 14 x 528, 14 x 14 x 832
            nn.MaxPool2d(3, stride=2, ceil_mode=True)  # 14 x 14 x 832 => 7 x 7 x 832
        )

        self.layer5 = nn.Sequential(
            InceptionV2(832, 256, 160, 320, 32, 128, 128),  # 7 x 7 x 832 => 7 x 7 x 832
            InceptionV2(832, 384, 192, 384, 48, 128, 128),  # 7 x 7 x 832 => 7 x 7 x 1024
